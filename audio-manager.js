...
export class AudioPlayer {
    ...
    findDeviceByName(deviceName) {
        ...
        const matchingDevice = devices.find(dev => dev.name.toLowerCase().includes(deviceName.toLowerCase()));
    ...
    async playAudioOnDevice(url, deviceNameOrId) {
        ...
        if (typeof deviceNameOrId === 'string') {
            ...
            throw new Error('Device must be specified by name (string) or ID (number)');
        }
